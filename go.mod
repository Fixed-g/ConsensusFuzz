...
require (
	chainmaker.org/chainmaker/libp2p-pubsub v1.1.3 // indirect
	chainmaker.org/chainmaker/net-common v1.2.3 // indirect
	chainmaker.org/chainmaker/net-libp2p v1.2.3 // indirect
	chainmaker.org/chainmaker/net-liquid v1.1.1 // indirect
	chainmaker.org/third_party/q-tls-common v1.0.0 // indirect
	...
	github.com/marten-seemann/qtls-go1-15 v0.1.3 // indirect
